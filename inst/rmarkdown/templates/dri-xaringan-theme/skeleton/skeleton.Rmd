...
output:
  xaringan::moon_reader:
    css: dri-theme.css
    ## If one needs to send the presentation as a file, use the following 
    ## option, though it may be safer to use a web browser to print to PDF
    #self_contained: true
...
RefManageR::BibOptions(check.entries = FALSE,
           ...
           dashed = FALSE)
## read bib file
## reference managment software should be able to export .bib files
...
knitr::include_graphics("dri_logo_mono.jpg")
```
]

.centre[
```{r, label='image-example', out.width='80%'}
knitr::include_graphics("images/dri_founders_nostrapline.jpg")
```
]
