...
knitr::include_graphics("images//UK DRI Logos/UK DRI MONO/JPG/UK Dementia Research Institute_LOGO_MONO.jpg")
```
]

.centre[
```{r, label='image-example', out.width='80%'}
knitr::include_graphics("images//UK DRI Logos/Founding Funders/UK DRI Founders_nostrapline_RGB.jpg")
```
]
